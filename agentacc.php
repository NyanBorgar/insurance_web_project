    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active" style="background-image: url(images/childplan.jpg)" >
                    <div class="container">
                ...
                <div class="item" style="background-image: url(images/p12.jpg)">
                    <div class="container">
                    </div>
                </div><!--/.item-->

                <div class="item" style="background-image: url(images/p5.jpg)">
                    <div class="container">
                    </div>
                </div><!--/.item-->
           ...
           <div class="center wow fadeInDown">
            ...
            <div class="row"  align="center">
                <div class="features">
                    ...
                    <div class="col-md-4 col-sm-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
                        <div class="feature-wrap">
                             <img src="images/retirement_plans.jpg" />
                            <h2>Retirement Plans</h2>
                            <h3>Retirement plan that provides regular payment and have regular premium payment term along with bonuses. Because you want to make the most of retired life.</h3>
                        </div>
                    </div><!--/.col-md-4-->
